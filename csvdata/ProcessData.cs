...
namespace csvdata
{
    ...
    public class CSVData
    {
        ...
        private TRecord ProcessRow(string row)
        {
        ...
        public void SaveToDB()
        {
            ...
            //conn.Open();
            foreach (TRecord record in Data)
            {
                ...
                Console.WriteLine("ID = {0} Name = {1} Price = {2}", record.ID, record.Name, record.Price);
